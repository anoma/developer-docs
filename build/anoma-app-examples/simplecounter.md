...
Before creating the SimpleCounter application, make sure to have [Juvix installed](simplecounter.md#prerequisites). Also consider looking at [Your First Anoma dApp](../your-first-anoma-application/) for some introductory explanations.
